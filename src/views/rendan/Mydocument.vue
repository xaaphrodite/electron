<template>
  <main>
    <header>
      <header-title title="My Document |Rendan" />
    </header>
    <article>
          ...
          <table v-if="resources.length">
            ...
            <tbody>
              <tr v-for="(document, index) in resultQuery" :key="document._id">
                ...
                <td data-label="Opsi">
                  <a v-if="document.position !== 'lakdan'" id="options" @click="download" :value="document._id" :title="document.title">Download </a>
                  <span v-if="document.position !== 'lakdan'">|</span>
                  <a id="options" data-bs-toggle="modal" data-bs-backdrop="false" :data-bs-target="`#${document.title.replace(/\s/g, '')}`"> Details </a>
                  <span v-if="document.position !== 'lakdan' && document.position !== 'divisi'">|</span>
                  <a v-if="document.position !== 'lakdan' && document.position !== 'divisi'" id="options" data-bs-toggle="modal" data-bs-backdrop="false" :data-bs-target="`#update${document.title.replace(/\s/g, '')}`"> Update</a>
                </td>
...
import DetailsModal from "../../components/rendan/details-modal.vue";
import UpdateModal from "../../components/rendan/update-modal.vue";
export default {
