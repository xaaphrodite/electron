<template>
  <main>
    <header>
      <header-title title="Upload |Rendan" />
    </header>
    <br />
    <article>
      <section>
        <div class="container form" style="color: #57646f">
          ...
          <form class="form" @submit.prevent="upload" enctype="multipart/form-data">
            ...
            <!--  -->
            <label for=""><b>Draft final RKS</b></label>
            ...
            <!--  -->
            <label for=""><b>ND penyampaian RKS & HPE</b></label>
            ...
            <!--  -->
            <label for=""><b>ND EVPSPROC</b></label>
...
import UploadModal from "../../components/rendan/upload-modal.vue";
export default {
  ...
  methods: {
    ...
    async upload() {
      ...
      setTimeout(async () => {
        ...
        formData.append("descOne", "Draft final RKS");
        formData.append("descTwo", "HPE");
        formData.append("descThree", "File excel HPE");
        formData.append("descFour", "ND penyampaian RKS & HPE");
        formData.append("descFive", "ND EVPSPROC");
        ...
        await axios
          ...
          .then((response) => {
            ...
            setTimeout(() => {
              this.$router.push("/dashboard/rendan/mydocument");
              progress.done();
            }, 1000);
          })
          .catch((error) => {
