                ...
                <div class="col" style="margin-top: 5px">
                  <div class="container">
                    ...
                    <p id="optionFile" class="fileOne" v-if="FC.fileOne && data.fileOne.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || document.position === 'divisi'" @click="dwndFile" :path="data.fileOne.path" loc="fileOne" :nameFile="data.fileOne.name">Download </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileOne.name" loc="fileOne">| Delete</span>
                    </p>
                    <br />
                    ...
                    <p id="optionFile" class="fileTwo" v-if="FC.fileTwo && data.fileTwo.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || document.position === 'divisi'" @click="dwndFile" :path="data.fileTwo.path" loc="fileTwo" :nameFile="data.fileTwo.name">Download </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileTwo.name" loc="fileTwo">| Delete</span>
                    </p>
                    <br />
                    ...
                    <p id="optionFile" class="fileThree" v-if="FC.fileThree && data.fileThree.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || document.position === 'divisi'" @click="dwndFile" :path="data.fileThree.path" loc="fileThree" :nameFile="data.fileThree.name">Download </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileThree.name" loc="fileThree">| Delete</span>
                    </p>
                    <br />
                    ...
                    <p id="optionFile" class="fileFour" v-if="FC.fileFour && data.fileFour.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || document.position === 'divisi'" @click="dwndFile" :path="data.fileFour.path" loc="fileFour" :nameFile="data.fileFour.name">Download </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileFour.name" loc="fileFour">| Delete</span>
                    </p>
                    <br />
                    ...
                    <p id="optionFile" class="fileFive" v-if="FC.fileFive && data.fileFive.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || document.position === 'divisi'" @click="dwndFile" :path="data.fileFive.path" loc="fileFive" :nameFile="data.fileFive.name">Download </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileFive.name" loc="fileFive">| Delete</span>
                    </p>
                    ...
                    <p id="optionFile" class="fileSix" v-if="FC.fileSix && data.fileSix?.name !== 'Tidak ada'">
                      <span id="green" v-if="document.position === 'rendan' || (document.position !== 'lakdan' && document.position !== 'divisi')" @click="dwndFile" :path="data.fileSix?.path" loc="fileSix" :nameFile="data.fileSix?.name">
                        Download
                      </span>
                      <span id="red" v-if="document.position === 'rendan'" @click="delFile" :itemid="document._id" :nameFile="data.fileSix?.name" loc="fileSix">| Delete</span>
                    </p>
                    <hr />
                    ...
                    <button v-if="document.position !== 'lakdan' && user" style="margin-right: 5px" class="btn btn-outline-success" @click="download" :value="document._id" :title="document.title">Download zip</button>
                    <button v-if="document.position !== 'lakdan' && ask" style="margin-right: 5px" class="btn btn-outline-success" @click="download" :value="document._id" :title="document.title">Download zip</button>
                    <button v-if="document.position === 'rendan' && ask" @click="danger" class="btn btn-outline-danger">Delete</button>
